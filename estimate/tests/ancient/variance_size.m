...
%
%% CAUTION
%results = horzcat(objfunc, status, param_matrix')
%writetable(array2table(results), '10p_4000i_5v_jhwi.csv')
%
...
theta_firststage = csvread('theta_firststage_plot.csv');
...
dlmwrite('variance_size_white.csv', T_covar_matrix_white, 'precision', 16);
dlmwrite('variance_size_homo.csv', T_covar_matrix_homo, 'precision', 16);
