...
estimation_data = readtable('estimation_data_all_nondirectional.csv','TreatAsEmpty',{'.','NA'});
...
bounds.lb = options.lb ;
bounds.ub = options.ub ;

writetable(struct2table(bounds), 'bounds_dir.csv') ;
