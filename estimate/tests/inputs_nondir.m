...
inputs = table2array(readtable('inputs_nondir.csv', 'HeaderLines', 1));
...
writetable(array2table(grads), 'inputs_gradients_nondir.csv') ;
writetable(array2table(sqerr), 'inputs_objective_nondir.csv') ;
