...
## Which city data to use ('all', 'ancient_system' or 'matched')
source = 'all'
...
path = '/home/delvillar/assyria/fdv/estimate/modern/par_estimation_dir.csv'
...
estimator = estimate.EstimateModern(e_type, source)
